...
public class Spawner : MonoBehaviour  //*
{
    ...
    [SerializeField] private int _repatCount;
    ...
    private void GenerateRandomElements(SpawnPoint[] spawnPoints, GameObject generatedElement, int spawnChance, float scaleY = 0.3f, float offsetY = 0)
    {
        for(int i = 0; i<spawnPoints.Length; i++)
        {
